...
void drawCircleDMA(int row, int col, int size, volatile u16 fillclr);
void drawCirclePix(int row, int col, int size, volatile u16 clr);
void drawRectOutlineDMA(int x, int y, int width, int height, volatile u16 color);
void drawfilteredImage(const u16 *image, int x, int y, int img_dimension, int filter);

unsigned short savePix(int col, int row, const u16 *image);
